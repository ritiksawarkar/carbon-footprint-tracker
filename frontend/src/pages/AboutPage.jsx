...
import { Brain, Cloud, Globe, Leaf, Lock, Users } from "lucide-react";

const AboutPage = () => {
  return (
    <div className="page-shell font-sans selection:bg-green-200 selection:text-green-900">
      <Navbar />
      ...
      {/* Footer minimal */}
      <footer className="mt-auto bg-white border-t border-slate-200 py-10 text-center text-slate-500 shadow-inner">
        <div className="flex items-center justify-center gap-2 mb-4">
          <span className="icon-shell icon-shell-sm icon-tone-green rounded-full">
        ...
        <p className="text-sm">
          Built with passion for the environment and technology.
        </p>
